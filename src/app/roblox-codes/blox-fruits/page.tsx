...
import { ArrowLeft, Copy, Gift, CalendarDays, PlusCircle, CheckSquare } from "lucide-react"; // Removed Square
            ...
            {codes.length > 0 ? (
              codes.map((item) => (
                <Card 
                  key={item.id} 
                  className={cn(
                    `p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 promo-code-card`, // Added promo-code-card class
